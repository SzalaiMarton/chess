...
public:
    ...
    static void afterMove(Objects::Piece* currentPiece, Objects::Piece*& prevRoundPiece, int& turn, bool& check, Objects::Board& chessBoard, std::vector<Objects::Indicator*>& checkLine, bool& alreadyCheckForBlock, bool& alreadyCheckForPromotion, std::vector<Objects::Piece*>& pinnedPieces);
